...
def uniteSetting():
	...
	DONE_ALARMUID = random_str(30) + "badDogger"
	# 
	global DONE_UnitUID
	DONE_UnitUID = random_str(20) + "badDogger"
	print("uniteSetting")
...
def basicSetting():
	info = "Welcome\nNow you will have to set up for this application.\n"
	print (info)
	
	info = "Set The First Monday(如：20160905):\n"
	# firstWeekDate = raw_input(info)
	firstWeekDate = "20190225"
	checkInput(checkFirstWeekDate, firstWeekDate)
	
	info = "Configuring Class Time\n"
	print(info)
	# try :
	setClassTime()
	print("Class Time Configured\n")
	# except :
	# 	sys_exit()

	info = "Configuring Class Information\n"
	print(info)
	# try :
	setClassInfo()
	print("Class Information Configured\n")
	# except :
	# 	sys_exit()

	info = "Setting up reminder\n[0] No reminder\n[1] 10 min before the class\n[2] 30 min before the class\n[3] 1 hour before the class \n [4] 2 hours before the class \n [5] 1 day before the class\n"
